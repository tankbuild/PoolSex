...
class VariantCalling():
    ...
    def generate_shell_files(self, data, parameters):
        ...
        male_file_path = os.path.join(data.directories.output, 'males_no_duplicates.bam')
        female_file_path = os.path.join(data.directories.output, 'females_no_duplicates.bam')
